...
public class NurseRegisterView {
    private VBox view;
    private User adminUser;

    public NurseRegisterView() {
        this(null);
    }

    public NurseRegisterView(User adminUser) {
    ...
    private void createView() {
        ...
        registerForm.setAlignment(Pos.CENTER_LEFT); // Left-aligned for professional form scanning
        ...
        Label titleLabel = new Label("Nurse Registration");
        titleLabel.setStyle("-fx-font-family: 'Segoe UI'; -fx-font-weight: bold; -fx-font-size: 26px; -fx-text-fill: #2d3748;");
        
        Label subTitle = new Label("Create a new nursing staff account");
        ...
        Label usernameLabel = new Label("Staff Username");
        ...
        Label emailLabel = new Label("Work Email");
        emailLabel.setStyle(labelStyle);
        TextField emailField = new TextField();
        emailField.setPromptText("nurse@hospital.com");
        ...
        // Primary Action Button (Clinical Green for Nursing/Operations)
        Button registerButton = new Button("REGISTER STAFF");
        ...
        // Navigation Button (Neutral style)
        ...
        registerButton.setOnAction(e -> {
            ...
            confirmAlert.setHeaderText("Create Nurse Account");
            confirmAlert.setContentText("Add this staff member to the system?");
            ...
            confirmAlert.showAndWait().ifPresent(response -> {
                if (response == javafx.scene.control.ButtonType.OK) {
                    try {
                        ...
                        if (userId != -1) {
                            NurseInfoView nurseInfoView = new NurseInfoView(userId, adminUser);
                            view.getScene().setRoot(nurseInfoView.getView());
                        }
                    } catch (Exception ex) {
